...
handler = logging.FileHandler('model_selct_log.log')
...
class SelectorDIC(ModelSelector):
	...
	def calc_dic(self, n_components):
		...
		logger.debug('Calculated Dic Score: {}'.format(dic_score))
...
class SelectorCV(ModelSelector):
	...
	def calc_cv(self, n_components, n_splits=2):
		...
		for train, test in splitter.split(self.sequences):
			...
			scores.append(model.score(X_test, leng_test))
